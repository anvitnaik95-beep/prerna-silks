...
export default function WhatsAppButton() {
  ...
  if (location.pathname.startsWith('/admin') || hideOn.includes(location.pathname)) return null;
  ...
  const handleClick = () => {
    if (user) {
      API.post('/enquiry/submit', {
        ...
        items: [{ productId: 'whatsapp', name: 'General Enquiry', quantity: 1 }],
        message: 'Contact request from WhatsApp button'
      }).catch(() => {});
    }
    window.open('https://wa.me/917019461619', '_blank');
  };
