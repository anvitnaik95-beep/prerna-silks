  ...
  return (
    <footer className="site-footer">
      <div className="footer-top">
        ...
        <div className="footer-col footer-brand">
          ...
          <div className="footer-social">
            ...
            <a href="https://youtube.com" target="_blank" rel="noreferrer" title="YouTube"><YoutubeIcon /></a>
            <a href="https://wa.me/917019461619" target="_blank" rel="noreferrer" title="WhatsApp"><WhatsAppIcon /></a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" title="LinkedIn"><LinkedInIcon /></a>
          </div>
        </div>
        ...
        <div className="footer-col">
          <h4>Get In Touch</h4>
          <ul>
            <li style={{ display:'flex', alignItems:'center', gap:8 }}><PhoneIcon /><a href="tel:+917019461619">+91 70194 61619</a></li>
            <li style={{ display:'flex', alignItems:'center', gap:8 }}><MailIcon /><a href="mailto:admin@prernasilks.com">admin@prernasilks.com</a></li>
            <li style={{ display:'flex', alignItems:'center', gap:8 }}><ClockIcon /> Mon–Sat: 10AM – 6PM</li>
            <li style={{ display:'flex', alignItems:'center', gap:8 }}><LocationIcon /> CBT Hubli, Karnataka 580029</li>
          </ul>
      ...
      <div className="footer-bottom-bar">
        <p>© {new Date().getFullYear()} Prerna Silks, CBT Hubli. All rights reserved. Crafted with <HeartIcon /> in India.</p>
        <div style={{ display:'flex', gap:16, fontSize:'0.78rem' }}>
          <a href="mailto:admin@prernasilks.com" style={{ color:'rgba(255,255,255,0.4)', textDecoration:'none' }}>Privacy Policy</a>
          <a href="mailto:admin@prernasilks.com" style={{ color:'rgba(255,255,255,0.4)', textDecoration:'none' }}>Terms of Use</a>
        </div>
      </div>
    </footer>
  );
